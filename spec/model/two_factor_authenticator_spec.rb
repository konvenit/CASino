...
describe CASino::TwoFactorAuthenticator do
  describe '.cleanup' do
    it 'deletes expired two-factor authenticators' do
      authenticator = FactoryBot.create :two_factor_authenticator, expiry: 10.hours.ago
      expect do
    ...
    it 'does not delete non-expired two-factor authenticators' do
      authenticator = FactoryBot.create :two_factor_authenticator, expiry: 1.hour.from_now
      expect do
        described_class.cleanup
